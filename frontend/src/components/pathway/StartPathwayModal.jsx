  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-2xl">
        <AlertDialogHeader>
          <AlertDialogTitle>
            Are you absolutely sure you want to start this pathway?
          </AlertDialogTitle>
          <AlertDialogDescription className="text-base">
            - You <b>cannot pause</b> or stop the pathway at any time.
            <br />
            - Once you start the pathway, it will be considered active and your stats will be
