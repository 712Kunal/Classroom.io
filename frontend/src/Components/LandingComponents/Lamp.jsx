...
export function Lamp() {
  return (
    <LampContainer className="flex flex-col items-center justify-center">
      <motion.h1
      ...
      >
        We are here to help you learn faster and more effectively.
      </motion.p>
    </LampContainer>
  );
}
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#030014] opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: '8rem' }}
