...
export function ProfileImageAndInfo({ user }) {
  return (
    <div className="sm:p-6 sm:rounded-lg sm:shadow-sm sm:shadow-gray-300 sm:rounded-none p-0 shadow-none">
      <div className="flex flex-col sm:flex-row sm:items-center justify-center">
        <div className="flex justify-center items-center mb-4 sm:mb-0 sm:w-1/3">
          <div className="w-auto sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full sm:border-2 sm:border-gray-200 overflow-hidden flex justify-center items-center">
            <img
              src={user.avatar || '/defaultAvatar.png'} // Fallback to defaultAvatar if no user avatar
              alt={user.username}
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700/50 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600/50 transition-colors duration-200">
  ...
  return (
    <Accordion.Root collapsible>
      <Accordion.Item value="field-of-study">
        <Accordion.Header>
          <Accordion.Trigger
            className="flex justify-between items-center w-full text-lg font-semibold text-gray-800 p-4 border-b border-gray-300"
        ...
        <Accordion.Content>
          <div className="flex justify-between items-center p-4 text-lg text-gray-700">
            <strong className="text-base font-medium text-gray-600">Field of Study:</strong>
      ...
      <Accordion.Item value="degree">
        ...
        <Accordion.Content>
          <div className="flex justify-between items-center p-4 text-lg text-gray-700">
            <strong className="text-base font-medium text-gray-600">Degree:</strong>
      ...
      <Accordion.Item value="years-of-experience">
        ...
        <Accordion.Content>
          <div className="flex justify-between items-center p-4 text-lg text-gray-700">
            <strong className="text-base font-medium text-gray-600">Years of Experience:</strong>
      ...
      <Accordion.Item value="location">
        ...
        <Accordion.Content>
          <div className="flex justify-between items-center p-4 text-lg text-gray-700">
            <strong className="text-base font-medium text-gray-600">Location:</strong>
      ...
      <Accordion.Item value="occupation">
        ...
        <Accordion.Content>
          <div className="flex justify-between items-center p-4 text-lg text-gray-700">
            <strong className="text-base font-medium text-gray-600">Occupation:</strong>
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center space-x-4 mb-6">
        <p className="text-lg text-gray-600"><strong>🪙</strong> {user.pointsAwarded}</p>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-center space-x-6 flex-wrap">
          {user.badgesAwarded.map((badge, index) => (
            <div
              key={index}
              className="w-12 h-12 sm:w-24 sm:h-24 md:w-20 md:h-20 lg:w-22 lg:h-22 xl:w-25 xl:h-25 relative overflow-hidden transform transition duration-300 ease-in-out hover:scale-110 hover:rotate-6 mb-4"
              style={{
                clipPath: 'polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%)',
                boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)', // Add shadow effect
              }}
            >
...
export function SkillsAndHobbies({ user }) {
  ...
  return (
    <div className="p-8 rounded-lg">
      <h3 className="text-xl font-semibold text-gray-900 mb-4">Skills & Hobbies</h3>
        ...
        <div className="flex gap-6 flex-wrap">
          {user.Background.Skills.map((skill, index) => (
            <div
              ...
              role="button"
              title="Hover chip"
              className={`${getItemColor(skill, "skills")} h-8 px-3 w-max flex gap-2 items-center rounded-full`}
            >
        ...
        <div className="flex gap-4 flex-wrap">
          {user.Background.Hobbies.map((hobby, index) => (
            <div
              ...
              role="button"
              title="Hover chip"
              className={`${getItemColor(hobby, "hobbies")} h-8 px-3 w-max flex gap-2 items-center rounded-full`}
            >
        ...
        <div className="flex gap-4 flex-wrap">
          {user.Background.Interests.map((interest, index) => (
            <div
              ...
              role="button"
              title="Hover chip"
              className={`${getItemColor(interest, "interests")} h-8 px-3 w-max flex gap-2 items-center rounded-full`}
            >
