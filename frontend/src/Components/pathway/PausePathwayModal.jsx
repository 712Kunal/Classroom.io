  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-2xl">
        <AlertDialogHeader>
          <AlertDialogTitle>
            Are you absolutely sure you want to pause this pathway?
          </AlertDialogTitle>
          <AlertDialogDescription className="text-base">
            - You can resume or restart the pathway at any time.
            <br />
            - Once you start the pathway, it will be considered active and your stats will be
            affected accordingly.
            <br />
            - If you want to resume the pathway, you can do so from the pathway timeline.
            <br />
          </AlertDialogDescription>
        </AlertDialogHeader>
