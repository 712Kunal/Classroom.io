  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-2xl">
        <AlertDialogHeader>
          <AlertDialogTitle>
            Are you absolutely sure you want to resume this pathway?
          </AlertDialogTitle>
          <AlertDialogDescription className="text-base">
            - You can again pause or stop the pathway at any time.
            <br />
            - Once you resume the pathway, it will be considered active and your stats will be
            affected accordingly.
            <br />
            - If you want to pause the pathway, you can do so from the pathway timeline.
            <br />
            - If you want to restart the pathway, you can do so from the pathway timeline aswell but
            be aware restarting unlike resume it will overrite your task completion history.
            <br />
          </AlertDialogDescription>
        </AlertDialogHeader>
