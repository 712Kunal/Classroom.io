  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-2xl">
        <AlertDialogHeader>
          <AlertDialogTitle>
            Are you absolutely sure you want to restart this pathway?
          </AlertDialogTitle>
          <AlertDialogDescription className="text-base">
            - If you restart the pathway, unlike resume it will overrite your task completion
            history.
            <br />
            - If you meant to resume the pathway, you can do so from the pathway timeline.
            <br />
            - Once you restart the pathway, it will be considered active and your stats will be
