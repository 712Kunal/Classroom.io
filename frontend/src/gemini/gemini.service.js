          ...
          properties: {
            ...
            tasks: {
              ...
              items: {
                  ...
                  resources: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        type: {
                          type: 'string',
                          enum: ['documentation', 'video', 'video tutorial', 'interactive exercise']
                        },
                        link: {
                          type: 'string'
                        }
                ...
                required: ['taskNumber', 'taskTitle', 'description', 'resources', 'expectedOutcome']
              }
            }
          },
          required: ['intervalNumber', 'summary', 'tasks']
        }
      }
    },
    required: ['topic', 'description', 'duration', 'intervals', 'intervalType', 'pathway']
  }
};
